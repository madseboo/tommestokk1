...
create table if not exists public.calculations (
  ...
  verktoy text not null check (verktoy in ('terrasse','dryppstop','rekkverk','parkett','kledning','levegg','pergola','utemaling','belegningsstein','plen','gjerde','innemaling','flis')),
